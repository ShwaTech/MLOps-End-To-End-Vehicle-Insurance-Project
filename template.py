...
list_of_files = [
    ...
    f"{project_name}/components/05_model_evaluation.py",
    f"{project_name}/components/06_model_pusher.py",
    ...
    f"{project_name}/pipline/01_training_pipeline.py",
    f"{project_name}/pipline/02_prediction_pipeline.py",
