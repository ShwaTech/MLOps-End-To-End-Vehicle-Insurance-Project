...
from src.pipeline.stage_02_prediction_pipeline import VehicleData, VehicleDataClassifier
from src.pipeline.stage_01_training_pipeline import TrainPipeline
